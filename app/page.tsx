...
export default function RidenLanding() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      {/* Navigation */}
      <motion.nav
        className="flex items-center justify-between px-4 sm:px-6 lg:px-12 py-4 sm:py-6 relative z-50"
      ...
      >
        ...
        >
          ...
          {/* Links */}
          <div className="lg:flex items-center gap-6 text-sm lg:text-base font-medium hidden sm:hidden">
            <motion.div whileHover={{ y: -2 }} transition={{ type: "spring", stiffness: 300 }}>
              <Link href="#" className="text-white hover:text-[#F80F0F] transition-colors duration-300">
                About us
              </Link>
            </motion.div>
        ...
        <div className="hidden md:flex items-center space-x-4 lg:space-x-8">
          ...
          >
            <span>🇨🇦</span>
            <span className="hidden lg:inline">Exclusively in Canada</span>
      ...
      >
        ...
        {/* App Store Buttons */}
        <motion.div
          className="flex flex-col  sm:flex-row gap-3 justify-center sm:gap-4 lg:gap-6 mb-12 sm:mb-16 lg:mb-20 w-full max-w-md sm:max-w-none"
          variants={itemVariants}
        >
          <motion.div
